            ...
            <Routes>
              ...
              <Route
                ...
                element={
                  <ProtectedRoute>
                    <div
                      className={`flex min-h-screen transition-[padding] ${!online ? "pt-12" : ""} ${appSettings.modoCurral ? "mode-curral" : ""} overflow-x-hidden`}
                    >
                      <Sidebar />
                      <div
                        className={`flex-1 min-h-screen transition-all duration-300 flex flex-col ${sidebarCollapsed ? "lg:ml-16" : "lg:ml-64"} overflow-x-hidden`}
                      >
                        <TopBar />
                          ...
                          <ErrorBoundary>
                            <Suspense fallback={<RouteLoader />}>
                              <Routes>
                                ...
                                <Route
                                  path="/planilha"
                                  element={<Navigate to="/animais" replace />}
                                />
                                <Route
                                  path="/matrizes"
                                  element={<Navigate to="/animais" replace />}
                                ...
                                />
                                <Route
                                  path="/confinamentos/:confinamentoId"
                                  element={
                                    <ProtectedRoute requiredPermission="ver_confinamentos">
                                      <DetalheConfinamento />
                                    </ProtectedRoute>
                                ...
                                <Route
                                  path="*"
                                  element={
                                    <ErrorPage variant="not_found" code={404} />
                                  }
                                />
                              </Routes>
                            </Suspense>
