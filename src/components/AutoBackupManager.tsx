        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-blue-800 dark:text-blue-400">
              ...
              <strong>Downloads</strong> do seu dispositivo (computador, tablet
              ou celular) com o formato:{" "}
              <code className="bg-blue-100 dark:bg-blue-900/40 px-1 py-0.5 rounded">
                backup_gestor_fazenda_YYYY-MM-DD.json
              </code>
            </p>
          </div>
        </div>
      ...
      <div className="p-4 bg-gray-50 dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700">
        ...
        <div className="space-y-4">
          ...
          <Combobox
            ...
            onChange={(option) =>
              option && updateSettings({ intervalMinutes: parseInt(option) })
            }
          ...
          <div className="space-y-2">
            <label className="flex items-center gap-2">
              <input
                ...
                onChange={(e) =>
                  updateSettings({ notifyOnSuccess: e.target.checked })
                }
                disabled={!settings.enabled}
            ...
            <label className="flex items-center gap-2">
              <input
                ...
                onChange={(e) =>
                  updateSettings({ notifyOnFailure: e.target.checked })
                }
                disabled={!settings.enabled}
                className="w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500 disabled:opacity-50"
              />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                updateSettings({ maxHistoryItems: Number(e.target.value) })
              }
              className="w-full"
            />
          </div>
  ...
  return (
    <>
      ...
      >
        ...
        {settings.enabled && (
          <span
            className={`absolute -top-1 -right-1 w-3 h-3 rounded-full ${getPrimaryBadgeClass(primaryColor)} animate-pulse`}
          />
        )}
      </button>
