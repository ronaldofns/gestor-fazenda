      ...
      <div className="p-2 sm:p-4 md:p-6 text-gray-900 dark:text-slate-100 max-w-full overflow-x-hidden">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
                <div
                  className={`p-2 rounded-lg ${getPrimaryBgClass(primaryColor)}`}
                >
                        ...
                        <div className="space-y-3">
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                setFiltroPeriodo(
                                  Number(e.target.value) as 3 | 6 | 12,
                                )
                              }
        ...
        <div className="mb-6 min-w-0">
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-gray-200/80 dark:border-slate-700 overflow-hidden">
            <div
              className={`bg-linear-to-r ${getThemeClasses(primaryColor, "gradient-to")} px-4 sm:px-5 py-4`}
            >
                ...
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs sm:text-sm text-white/90 truncate">
                      Distribuição por categoria e sexo
                    </p>
                  </div>
                </div>
                {metrics.tiposOrdenados.length > 0 && (
                  <div className="flex flex-wrap items-center gap-3 sm:gap-4 text-white/95 text-xs sm:text-sm">
                    <span className="flex items-center gap-1.5">
                      <Icons.Mars className="w-3.5 h-3.5 sm:w-4 sm:h-4 opacity-90 shrink-0" />
                      <strong>{metrics.machos.toLocaleString("pt-BR")}</strong>{" "}
                      machos
                    </span>
                    <span className="flex items-center gap-1.5">
                      <Icons.Venus className="w-3.5 h-3.5 sm:w-4 sm:h-4 opacity-90 shrink-0" />
                      <strong>{metrics.femeas.toLocaleString("pt-BR")}</strong>{" "}
                      fêmeas
                    </span>
                  </div>
                )}
                  ...
                  >
                    ...
                    <div className="flex flex-wrap items-center gap-2 order-2 min-w-0">
                      <span className="inline-flex items-center gap-1 py-1 px-2 rounded-lg bg-blue-50 dark:bg-blue-950/50 text-blue-700 dark:text-blue-300 text-xs font-semibold tabular-nums">
                        <Icons.Mars className="w-3.5 h-3.5 shrink-0" />{" "}
                      ...
                      <span className="inline-flex items-center gap-1 py-1 px-2 rounded-lg bg-pink-50 dark:bg-pink-950/50 text-pink-700 dark:text-pink-300 text-xs font-semibold tabular-nums">
                        <Icons.Venus className="w-3.5 h-3.5 shrink-0" />{" "}
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-slate-800">
                  {metrics.tiposOrdenados.length === 0 ? (
                    <tr>
                      <td
                        colSpan={4}
                        className="py-12 text-center text-sm text-gray-500 dark:text-slate-400"
                      >
                        Nenhum tipo cadastrado
                      </td>
                    </tr>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-6">
          ...
          <div
            className={`bg-white dark:bg-slate-900 rounded-xl shadow-sm p-5 border-l-4 ${getThemeClasses(primaryColor, "border")} hover:shadow-md transition-all duration-200`}
          >
            <div className="flex items-start justify-between gap-2 mb-3">
              ...
              <Icons.Cow
                className={`w-7 h-7 ${getThemeClasses(primaryColor, "text")}`}
              />
            </div>
            ...
            <div className="flex items-center gap-2 text-xs">
              ...
              {metrics.variacaoMes !== 0 && (
                <div
                  className={`flex items-center gap-1 ${metrics.variacaoMes > 0 ? "text-green-600" : "text-red-600"}`}
                >
                  {metrics.variacaoMes > 0 ? (
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm p-5 border-l-4 border-red-500 hover:shadow-md transition-all duration-200">
            ...
            <div className="text-xs text-gray-600 dark:text-slate-400">
              {metrics.totalMortos}{" "}
              {metrics.totalMortos === 1 ? "animal morto" : "animais mortos"}
            </div>
          </div>
            ...
            <div className="text-xs text-gray-600 dark:text-slate-400">
              {metrics.gmdPorCategoria.length > 0 ? (
                <>
                  ...
                  <span className="font-semibold text-purple-600 dark:text-purple-400">
                    {
                      metrics.gmdPorCategoria.sort((a, b) => b.gmd - a.gmd)[0]
                        .categoria
                    }
                  </span>{" "}
                  (
                  {metrics.gmdPorCategoria
                    .sort((a, b) => b.gmd - a.gmd)[0]
                    .gmd.toFixed(2)}{" "}
                  kg/dia)
                </>
              ) : (
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm p-5 border-l-4 border-amber-500 hover:shadow-md transition-all duration-200">
            ...
            <div className="text-3xl font-bold text-gray-900 dark:text-slate-100 mb-2">
              {metrics.iepMedio > 0 ? Math.round(metrics.iepMedio) : 0}{" "}
              <span className="text-base text-gray-600 dark:text-slate-400">
                dias
              </span>
            </div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm p-5 border-l-4 border-cyan-500 hover:shadow-md transition-all duration-200">
            ...
            <div className="text-xs text-gray-600 dark:text-slate-400">
              ...
              desmamas de{" "}
              <span className="font-semibold">{metrics.totalNascimentos}</span>{" "}
              nascimentos
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-gray-900 dark:text-slate-100">
                  {metrics.comparativoMes.totalAtual}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-slate-400">
                  Total no fim do mês passado
                </span>
                <span className="text-gray-700 dark:text-slate-300">
                  {metrics.comparativoMes.totalAnterior}
                </span>
              </div>
              <div
                className={`flex justify-between font-medium ${metrics.comparativoMes.variacao >= 0 ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"}`}
              >
                <span>Variação</span>
                <span>
                  {metrics.comparativoMes.variacao >= 0 ? "+" : ""}
                  {metrics.comparativoMes.variacao} (
                  {metrics.comparativoMes.variacaoPercentual >= 0 ? "+" : ""}
                  {metrics.comparativoMes.variacaoPercentual.toFixed(1)}%)
                </span>
              </div>
              <div className="border-t border-gray-200 dark:border-slate-600 pt-2 mt-2">
                <div className="flex justify-between text-green-600 dark:text-green-400">
                  ...
                  <span className="font-semibold">
                    {metrics.comparativoMes.nascimentosAnterior}
                  </span>
                </div>
                <div className="flex justify-between text-gray-600 dark:text-slate-400 mt-1">
                  ...
                  <span className="text-xs font-medium">
                    {metrics.comparativoMes.nascimentosAtual}
                  </span>
                </div>
                <p className="text-[10px] text-gray-500 dark:text-slate-500 mt-1">
                  Por data de nascimento • apenas bezerros
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm p-5 border border-gray-200 dark:border-slate-700">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-gray-900 dark:text-slate-100">
                  {metrics.comparativoAno.totalAtual}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-slate-400">
                ...
                <span className="text-gray-700 dark:text-slate-300">
                  {metrics.comparativoAno.totalAnterior}
                </span>
              </div>
              <div
                className={`flex justify-between font-medium ${metrics.comparativoAno.variacao >= 0 ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"}`}
              >
                <span>Variação</span>
                <span>
                  {metrics.comparativoAno.variacao >= 0 ? "+" : ""}
                  {metrics.comparativoAno.variacao} (
                  {metrics.comparativoAno.variacaoPercentual >= 0 ? "+" : ""}
                  {metrics.comparativoAno.variacaoPercentual.toFixed(1)}%)
                </span>
              </div>
            </div>
          </div>
          ...
          <div
            className={`bg-white dark:bg-slate-900 rounded-xl shadow-sm p-5 border-2 ${
              metrics.tendenciaRebanho === "crescimento"
                ? "border-green-500"
                : metrics.tendenciaRebanho === "queda"
                  ? "border-red-500"
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              ...
              {metrics.tendenciaRebanho === "estavel" && (
            ...
            <p
              className={`text-sm mt-1 ${metrics.tendenciaPercentual >= 0 ? "text-green-600 dark:text-green-400" : metrics.tendenciaPercentual < 0 ? "text-red-600 dark:text-red-400" : "text-gray-600 dark:text-slate-400"}`}
            >
              {metrics.tendenciaPercentual >= 0 ? "+" : ""}
              {metrics.tendenciaPercentual.toFixed(1)}% vs 3 meses anteriores
            </p>
          </div>
        </div>
              ...
              <table className="w-full text-sm min-w-[700px]">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-slate-700">
                    <th className="text-left py-3 px-2 font-semibold text-gray-700 dark:text-slate-300">
                      Fazenda
                    </th>
                    <th className="text-center py-3 px-2 font-semibold text-gray-700 dark:text-slate-300">
                      Total
                    </th>
                    <th className="text-center py-3 px-2 font-semibold text-gray-700 dark:text-slate-300">
                      Vivos
                    ...
                    <th className="text-center py-3 px-2 font-semibold text-cyan-600 dark:text-cyan-400">
                      Novilhas
                    </th>
                    <th className="text-center py-3 px-2 font-semibold text-gray-600 dark:text-slate-400">
                      Outros
                    </th>
                    <th className="text-center py-3 px-2 font-semibold text-gray-700 dark:text-slate-300">
                      %
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm p-5 hover:shadow-md transition-shadow mt-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-slate-400 mt-0.5">
                  Comparativo: total, nascimentos, mortes, GMD e taxa de desmama
                  (12 meses)
                </p>
              </div>
              ...
              <table className="w-full text-sm min-w-[600px]">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-slate-700">
                    ...
                    <th className="text-center py-3 px-2 font-semibold text-green-600 dark:text-green-400">
                      Nasc. 12m
                    </th>
                    <th className="text-center py-3 px-2 font-semibold text-red-600 dark:text-red-400">
                      Mortes 12m
                    </th>
                    <th className="text-center py-3 px-2 font-semibold text-purple-600 dark:text-purple-400">
                      GMD (kg/dia)
                ...
                <tbody>
                  {metrics.benchmarkingFazendas.map((fazenda, index) => (
                    ...
                    >
                      ...
                      <td className="text-center py-3 px-2 text-purple-600 dark:text-purple-400 font-medium">
                        {fazenda.gmdMedio > 0
                          ? fazenda.gmdMedio.toFixed(2)
                          : "-"}
                      </td>
                      <td className="text-center py-3 px-2 text-cyan-600 dark:text-cyan-400 font-medium">
                        {fazenda.taxaDesmama > 0
                          ? `${fazenda.taxaDesmama.toFixed(1)}%`
                          : "-"}
                      </td>
                    </tr>
                  ))}
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-purple-600 dark:text-purple-400">
                        {fazenda.gmdMedio > 0
                          ? `${fazenda.gmdMedio.toFixed(2)} kg/dia`
                          : "-"}
                      </span>
                    </div>
                    <div className="flex justify-between col-span-2">
