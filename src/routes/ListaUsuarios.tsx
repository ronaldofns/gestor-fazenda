...
export default function ListaUsuarios() {
  ...
  const [usuarioEditando, setUsuarioEditando] = useState<{ id: string } | null>(
    null,
  );
              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-slate-800">
                <thead className="bg-gray-100 dark:bg-slate-800">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-slate-300 uppercase tracking-wider">
                      Status
                    </th>
                    <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-slate-300 uppercase tracking-wider">
                      Ações
                ...
                <tbody className="bg-white dark:bg-slate-900 divide-y divide-gray-200 dark:divide-slate-800">
                  {usuarios.map((usuario) => (
                    <tr
                      ...
                      className={
                        !usuario.ativo
                          ? "bg-gray-50 dark:bg-slate-800/60 opacity-60"
                          : ""
                      }
                    >
                      ...
                      <td className="px-4 py-3 whitespace-nowrap">
                        <span
                          className={`px-2 py-1 text-xs font-semibold rounded-full ${ROLE_COLORS[usuario.role]}`}
                        >
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0">
                      ...
                      <div className="text-xs text-gray-500 dark:text-slate-400 wrap-break-word">
                        {usuario.email}
                      </div>
